...
def test_draft_runs_after_hubspot_and_persists_before_notification() -> None:
    ...
    expected_path = [
        ...
        ("Sanitize Draft Persistence", "Create Approval Token"),
        ("Create Approval Token", "Sanitize Approval Token"),
        ("Sanitize Approval Token", "Notify Only After Draft Persistence"),
